...
jQuery(window).load(function() {
	...
	if( 640 < window.outerWidth && window.outerWidth < 850){
		console.log("inmasonry")
		jQuery(function(){
	...
	jQuery(window).resize(function() {
		jQuery('#mas-wrapper,#sidebar,#footer').masonry('reload');
		if( jQuery(document).width() > 850){
			jQuery('.widget-mas,.footer-widgets').removeAttr('style');
		}
	});
});