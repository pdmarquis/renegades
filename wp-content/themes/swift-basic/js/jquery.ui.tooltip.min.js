...
jQuery(function() {
	jQuery( ".mosaic li" ).tooltip({ 
		...
		open: function( event, ui ) {
			//console.log('Whn tool tip is opened')	
		},
		close: function( event, ui ) {
			//console.log('delayed')
			//setTimeout(function(){console.log('im delayed for 3 seconds')},3000)
...
jQuery(function() {
	jQuery( ".fbm li" ).tooltip({ 
		...
		content: function(){
			var element = jQuery( this );
			return element.find('.comment-content').html()
		},
		open: function( event, ui ) {
			//console.log('Whn tool tip is opened')	
		},
