...
<div id="content" role="main">
	...
	?>
		<div id="author-info" class="clearfix" style="margin-top: 20px">
			...
			<?php printf( ( ( get_the_author_posts() > 0 ) ? _n( '%1$s has written %2$s article so far, you can find it below.', '%1$s has written %2$s articles so far, you can find them below.', get_the_author_posts(), 'swift' ) : __( '%1$s has written no articles so far.', 'swift' ) ), $curauth->nickname, '<strong>'.get_the_author_posts().'</strong>' ); ?>
			<br />
		</div>
	</div>
