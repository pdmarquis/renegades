...
<footer>
    ...
    <!--
     * copyright-1.php and copyright-2.php exist in the parent theme.  
     * I created copyright-3.php and call it directly, rather than the way it used to be 
     * called (in the next php line which is now commented out).
     -->
    <?php// get_template_part("copyright-{$swift_design_options['copyright_style']}"); ?>
    <?php get_template_part("copyright-3"); ?>
