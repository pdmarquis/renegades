 ...
 */
get_header();
global $swift_count,$swift_options,$swift_design_options,$swift_slider_posts_ids;
...
?>
		...
		<article id="post-0" class="post no-results not-found clearfix">
			...
			<div class="entry-content">
				<p><?php _e( 'Apologies, but there are no posts in the current context. Perhaps searching will help find a related post.', 'swift' ); ?></p>
				<?php get_search_form(); ?>
			</div><!-- .entry-content -->
		</article><!-- #post-0 -->
		<div class="clear"></div>
