<?php
/**
 * Plugin Name: SwiftDynamicThumbs
 ...
 *
 * @author Satish Gandham <satish.iitg@gmail.com>
 ...
 * @param array $sizes
 */
function swift_stop_thumbs($sizes)
{
    GLOBAL $swift_design_options;
    if ($swift_design_options['rebuild_thumbnail'])
        return $sizes;
...
add_filter('intermediate_image_sizes_advanced', 'swift_stop_thumbs');
