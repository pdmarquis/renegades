...
function swift_functions()
{
    ...
    require_once(trailingslashit(SWIFT_ADMIN) . 'class-tgm-plugin-activation.php');
    require_once(trailingslashit(SWIFT_ADMIN) . 'plugin-recomendation.php');
...
if (!function_exists('swift_setup')):
	...
	*/
        ...
        function swift_add_custom_styles()
        {
            ...
            if(isset($swift_options['is_writable']) && $swift_options['is_writable']){
               wp_enqueue_style( 'swift-main', get_template_directory_uri() . '/style.css' );


            if ( is_rtl() ) {
                wp_enqueue_style(  'swift-main-rtl',  get_template_directory_uri().'/css/rtl.css' );
            }



            if ( is_child_theme() ) {
                wp_enqueue_style( 'swift-child-theme', trailingslashit( get_stylesheet_directory_uri() ) . 'style.css' );
            }

            $upload_dir = wp_upload_dir();
            wp_enqueue_style('swift-custom', $upload_dir['baseurl'] . '/swift-magic/custom-styles.css');
            ...
            wp_enqueue_style( 'swift-main', get_template_directory_uri() . '/css/all-styles.css' );
